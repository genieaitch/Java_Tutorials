...
public class StringBuilderEx {
    ...
    deleteCharAt(int index) = 지정된 인덱스의 문자 하나를 삭제
    replace(int start, int end, String str) = 지정한 범위의 문자열을 다른 문자열로 대체함
    ...
    */
    ...
    public void methodStringBuilder(){
        ...
        //sb2에 World 문자열 추가
        sb2.append("World"); //String이기 때문에 자료형 String
        ...
        sb2.delete(6,13);
        System.out.println("4. 6~13 범위 값 삭제 : " + sb2);
