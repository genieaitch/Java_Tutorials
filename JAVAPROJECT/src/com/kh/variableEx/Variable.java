...
public class Variable {
    public static void main(String[] args) {
        ...
        /*
         ...
         float   (4byte) - 숫자 뒤에 f
         double  (8byte) - 실수에서 기본 사용

         char    (2byte) - 문자 하나, 문자 양 옆에 ''(작은 따옴표)
        */

            //참조 자료형
        /*
        String - 작성하는 값이 곧 크기이기 때문에 크기를 가늠할 수 없음
               - ""(큰 따옴표)를 사용해서 내용 작성 맨 첫글자는 대문자 S
        */

        //변수 선언 : 메모리에 공간 생성

        boolean isTrue; //컴퓨터 메모리에 boolean 저장공간 1byte를 생성하고
        //아직 그 공간에는 아무 것도 없는 상태이지만
        //그 공간의 이름을 isTrue라고 부르겠다.

        //값 대입 : 변수에 값을 집어넣는 것 (이미 값이 존재하는 변수에 대입하면 덮어쓰기가 됨)
        isTrue = true;
