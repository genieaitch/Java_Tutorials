...
public class StudentService {
    public static void main(String[] args) {
        ...
        student2 = if문을 이용해 프론트엔드에서 전달받은 값을 한 번 더 검증하고
        DB에 전달된 값을 저장
        ...
        */
        ...
        if(inputName != null && inputName.length() <= 6) {
            ...
            System.out.println("이름은 6글자 이후여야하고, 빈 공간일 수 없습니다 : " + inputName + "저장 불가");
        }
        ...
        //매개변수 생성자를 이용해서 학생 3번은 이름 나이를 필수로 입력받되, idCard 선택적으로 set을 이용
        ...
        studentArrayList.add(students[0]); //객체 배열로 저장된 학생 0 추가
        studentArrayList.add(students[1]); //객체 배열로 저장된 학생 1 추가
        studentArrayList.add(student2); //오직 set으로만 저장된 학생 2 추가
        studentArrayList.add(student3); //매개변수와 set으로 작성된 학생 3 추가
