...
public interface EmployeeService {
     ...
     * @param ent_yn
     */
    default void updateEmployee(String emp_name, String email, String phone, String dept_code, String sal_level, String job_code, double salary, double bonus, String manager_id, Date ent_date, char ent_yn){
     ...
     * 회원정보를 조회할 때 사원번호나 사원이름, 사원이메일로 조회가능
     * @param emp_id
     * @param emp_name
     * @param email
     */
     ...
     * 회원정보를 조회할 때 사원번호가 존재하면 조회가능
     * @param info_emp
     * 사원번호 또는 사원이름 또는 사원이메일 중 하나라도 일치하는 정보가 존재하면 회원정보 조회
     */
    void viewEmployee(String info_emp);

    /**
     * 사원의 이름과 이메일이 일치하는 회원정보 조회 기능
     * 동명이인이 존재할 때 추가적인 정보확인으로 이름과 이메일이 일치하는 회원정보 조회
     * 회원정보를 조회할 때 사원이름이나 사원이메일로 조회가능
     * @param emp_name
     * @param email
     */
